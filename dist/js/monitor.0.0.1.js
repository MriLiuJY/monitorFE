...
var _eventCenter = _interopRequireDefault(__webpack_require__("/tra"));
...
function InitMonitor(userConfig) {
  ...
  const eventCenter = new _eventCenter.default();
...
InitMonitor.prototype = {
  _initListenJS: function () {
    const self = this; // 监听全局下的 Promise 错误
    ...
    let errorEvent = function (err) {
      if (err.cancelable) {
        ...
        if (err.filename.indexOf('monitor') > -1 || "production" === 'development') {
          ...
          (0, _error.getJsError)(err, self._config);
        }
      } else {
        // 静态资源加载的error事件
        (0, _error.geetResourceError)(err, self._config);
      }
    };
...
var _monitor = _interopRequireDefault(__webpack_require__("y11X"));
...
function Index(userConfig, callback) {
  ...
  callback(new _monitor.default(init)); // 初始化
...
exports.geetResourceError = exports.getJsError = exports.ajaxError = exports.getServerError = void 0;
...
exports.geetResourceError = geetResourceError;
